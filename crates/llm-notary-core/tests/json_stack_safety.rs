...
//! capture-completion budget enforcement, deferred finalization, and local
...
use llm_notary_core::DEFAULT_MAX_ATTESTABLE_HTTP_BYTES;
...
const CHILD_ENV: &str = "LLM_NOTARY_JSON_STACK_SAFETY_CHILD";
...
///
/// `cargo test -p llm-notary-core --test json_stack_safety -- --ignored --nocapture`
#[test]
