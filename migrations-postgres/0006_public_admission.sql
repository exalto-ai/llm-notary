...
ALTER TABLE publish_jobs ADD COLUMN verification_started_at BIGINT;
ALTER TABLE publish_jobs ADD COLUMN actual_size_bytes BIGINT;
ALTER TABLE publish_jobs ADD COLUMN actual_sha256 TEXT;
ALTER TABLE publish_jobs ADD COLUMN admitted_at BIGINT;
ALTER TABLE publish_jobs ADD COLUMN private_purged_at BIGINT;
ALTER TABLE publish_jobs ADD COLUMN public_trace_object_key TEXT;
ALTER TABLE publish_jobs ADD COLUMN public_trace_size_bytes BIGINT;
...
ALTER TABLE publish_jobs ADD COLUMN public_stamp_size_bytes BIGINT;
