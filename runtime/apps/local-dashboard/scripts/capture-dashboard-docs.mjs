...
const outputDir = resolve(runtimeRoot, 'docs/images/local-dashboard');
...
try {
  ...
  try {
    ...
    await capture(browser, {
      file: 'mobile-share-choice.png',
      scheme: 'light',
      viewport: { width: 390, height: 844 },
      route: 'view=sharing',
    });
    await capture(browser, {
      file: 'mobile-share-preview.png',
      scheme: 'light',
      viewport: { width: 390, height: 844 },
      route: 'view=sharing',
      prepare: async (page) => {
